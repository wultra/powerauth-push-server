...
import com.wultra.push.service.apns.ApnsRejectionReason;
import com.wultra.push.service.fcm.FcmClient;
import com.wultra.push.service.fcm.FcmModelConverter;
import com.wultra.push.service.fcm.model.FcmSuccessResponse;
...
public class PushSendingWorker {
    ...
    void sendMessageToHms(final HmsClient hmsClient, final PushMessageBody pushMessageBody, final PushMessageAttributes attributes, final Priority priority, final String pushToken, final PushSendingCallback callback) throws PushServerException {
        final com.wultra.push.service.hms.request.Message message = buildHmsMessage(pushMessageBody, attributes, priority, pushToken);
     ...
     */
    private com.wultra.push.service.hms.request.Message buildHmsMessage(final PushMessageBody pushMessageBody, final PushMessageAttributes attributes, final Priority priority, final String pushToken) throws PushServerException {
        final var androidConfigBuilder = com.wultra.push.service.hms.request.AndroidConfig.builder()
        ...
        final var notificationBuilder = com.wultra.push.service.hms.request.AndroidNotification.builder()
        ...
        return com.wultra.push.service.hms.request.Message.builder()
