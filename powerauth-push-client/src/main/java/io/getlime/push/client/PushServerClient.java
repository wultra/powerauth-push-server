...
public class PushServerClient {
     ...
     *
     */
    private <T> T getObjectImpl(String url, Map<String, Object> params, TypeReference<T> typeReference) throws PushServerClientException {
        try {
    ...
    private <T> T postObjectImpl(String url, Object request) throws PushServerClientException {
        return postObjectImpl(url, request, new TypeReference<T>() {});
    }
     ...
     * @throws PushServerClientException In case of network, response / JSON processing, or other IO error.
     */
    private <T> T postObjectImpl(String url, Object request, TypeReference<T> typeReference) throws PushServerClientException {
        try {
    ...
    private <T> T putObjectImpl(String url, Object request) throws PushServerClientException {
        return putObjectImpl(url, request, new TypeReference<T>() {});
    }
     ...
     * @throws PushServerClientException In case of network, response / JSON processing, or other IO error.
     */
    private <T> T putObjectImpl(String url, Object request, TypeReference<T> typeReference) throws PushServerClientException {
        try {
     ...
     */
    private <T> T checkHttpStatus(TypeReference<T> typeReference, HttpResponse response) throws IOException, PushServerClientException {
