-- Changeset powerauth-push-server/1.9.x/20241011-add-tag-1.9.0.xml::1::Lubos Racansky
...
ALTER TABLE push_app_credentials ADD apns_private_key BLOB;

ALTER TABLE push_app_credentials ADD apns_team_id VARCHAR2(255);

ALTER TABLE push_app_credentials ADD apns_key_id VARCHAR2(255);

ALTER TABLE push_app_credentials ADD apns_bundle VARCHAR2(255);

ALTER TABLE push_app_credentials ADD apns_environment VARCHAR2(255);
...
ALTER TABLE push_app_credentials ADD fcm_private_key BLOB;

ALTER TABLE push_app_credentials ADD fcm_project_id VARCHAR2(255);

-- Changeset powerauth-push-server/1.10.x/20241029-migrate-ios-to-apns.xml::5::Lubos Racansky
...
-- Changeset powerauth-push-server/1.10.x/20241029-migrate-android-to-fcm.xml::6::Lubos Racansky
