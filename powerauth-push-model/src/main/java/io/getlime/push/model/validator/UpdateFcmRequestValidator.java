...
import io.getlime.push.model.request.UpdateFcmRequest;

/**
 * Validator class for update FCM request.
 *
 * @author Roman Strobl, roman.strobl@wultra.com
 */
public class UpdateFcmRequestValidator {

    /**
     * Validate {@link UpdateFcmRequest} instance.
     *
     * @param request Request to be validated.
     * @return Error message, or null in case of no error.
     */
    public static String validate(UpdateFcmRequest request) {
        if (request == null) {
