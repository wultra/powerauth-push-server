...
import com.wultra.push.model.request.RemoveIosRequest;

/**
 * Validator class for remove iOS request.
 *
...
public class RemoveIosRequestValidator {
    ...
    /**
     * Validate {@link RemoveIosRequest} instance.
     *
     * @param request Request to be validated.
     * @return Error message, or null in case of no error.
     */
    public static String validate(RemoveIosRequest request) {
        if (request == null) {
