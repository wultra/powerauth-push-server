...
import com.wultra.push.model.request.UpdateIosRequest;

/**
 * Validator class for update iOS request.
 *
...
public class UpdateIosRequestValidator {
    ...
    /**
     * Validate {@link UpdateIosRequest} instance.
     *
     * @param request Request to be validated.
     * @return Error message, or null in case of no error.
     */
    public static String validate(UpdateIosRequest request) {
        if (request == null) {
